...
/**
 * para enviar ar mensagens foi utilizado o MQTTBOX
 *
 *
 *
...
public class PahoMqttClient {
    ...
    /**
     * Estabelecendo a conexao com o cliente MQQT
     * @param context a activity
     * @param brokerUrl url do MQTT do eclipse
     * @param clientId id gerada pelo MQTTBOX
     * @return
     */
    ...
    /**
     * publicando uma mensagem em um topico ..
     * @param client
     * @param msg
     * @param qos
     * @param topic
    ...
    /**
     * se escrevendo em um topico ou canal para receber as mensagens
     * @param client
     * @param topic
     * @param qos
     * @throws MqttException
    ...
    /**
     * removendo sua inscrisão de um canal ... ai nao é mais possivel receber as mensagens
     * @param client
     * @param topic
     * @throws MqttException
     */
